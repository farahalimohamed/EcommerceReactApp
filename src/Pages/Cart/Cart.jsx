...
export default function Cart() {
  const { getLoggedCart, removeProductFromCart } = useContext(CartContext);
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              <div className="md:col-span-2 space-y-4">
                {cartData.products.map((product) => (
                  <div key={product._id} className="grid grid-cols-3 items-start gap-4">
                    ...
                    <div className="ml-auto">
                      ...
                      >
                        ...
                        <span className="mx-3 font-bold">{product.count}</span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="w-2.5 fill-current"
                          viewBox="0 0 42 42"
              ...
              <div className="bg-gray-100 rounded-md p-4 h-max">
                ...
                <div className="mt-6 space-y-3">
                  <button
                    type="button"
                    className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-blue-700 hover:bg-blue-800 text-white rounded-md"
                  >
                    Checkout
                  </button>
                  <button
