...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gray-100 py-3 dark:bg-gray-900 relative">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div className="flex items-center space-x-8">
          ...
          {token && (
            <div
              className="hidden w-full md:block md:w-auto absolute md:static bg-gray-100 top-[70%] left-0 z-[9999]"
              id="navbar-default"
            >
